...
# `doublebarrelshotgun_maxBullet` -> `[your gun name]_maxBullet`
# `doublebarrelshotgun_maxDistance` -> `[your gun name]_maxDistance`
# `doublebarrelshotgun_maxDamage` -> `[your gun name]_maxDamage`
